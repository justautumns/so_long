...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/08 14:36:01 by mehmeyil          #+#    #+#             */
/*   Updated: 2023/12/08 14:54:44 by mehmeyil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	valid_move(t_game *game, int col, int line, int pressed_key)
{
	...
	{
		game->end_game = 1;
		ft_putstr_fd("End of Game Congrats!", 1);
		close_window(game);
	}
...
static void	move_bhr(t_game *game, int col, int line, int pressed_key)
{
	int	valid;
	int	tcol;
	int	tline;
...
int	key_handler(int keycode, t_game *game)
{
	...
	if (keycode == A)
		...
		close_window(game);
	if (game->end_game != 1)
		move_bhr(game, col, line, keycode);
	return (0);
}
